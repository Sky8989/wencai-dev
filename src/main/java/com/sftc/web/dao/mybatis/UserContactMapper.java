...
public interface UserContactMapper {
    ...
    UserContact friendDetail(@Param("userUUId") String userUUId, @Param("friendUUId") String friendUUId);
     ...
     * 星标好友
     */
    void starFriend(@Param("userUUID") String userUUID, @Param("friendUUId") String friendUUId, @Param("is_tag_star") int is_star);
