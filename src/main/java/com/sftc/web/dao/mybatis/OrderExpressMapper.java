...
public interface OrderExpressMapper {
    ...
    void updateOrderExpressUuidAndReserveTimeById(
            @Param("id") int id,
     ...
     * 根据id更改快递状态
     */
    void updateOrderExpressStatus(
            @Param("express_id") int express_id,
     ...
     * 根据uuid更改订单状态
     */
    void updateOrderExpressStatusByUUID(
            @Param("uuid") String uuid,
    ...
    void updateExpressDirectedByUUID(
            @Param("uuid") String uuid,
            @Param("status") String status,
            @Param("directed_code") String directed_code,
            @Param("is_directed") int is_directed
    );

    //根据 uuid 更改订单的 Attributes 和状态
    void updateAttributesAndStatusByUUID(
            @Param("uuid") String uuid,
    ...
    void updateOrderTime(
            ...
            @Param("quote_uuid") String quote_uuid
    );
     ...
     * @return 返回订单id的列表
     */
    List<String> selectOrderIdForsyncSFExpressStatus(String userUUId);

    //查询 来往记录所需的快递
    List<OrderExpress> selectExpressForContactInfo(
            @Param("sender_user_uuid") String sender_user_uuid,
            @Param("ship_user_uuid") String ship_user_uuid
    );
     ...
     * @return 返回快递列表
     */
    List<OrderExpress> selectExpressForsyncSFExpressStatus(List<String> orderIdList);
