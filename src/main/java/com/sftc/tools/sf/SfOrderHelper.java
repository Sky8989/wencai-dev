...
public class SfOrderHelper {
     ...
     * @return
     */
    private static String getRandomOpenId(int length) {
    ...
    public static String getOrderId() {
        return getRandomId(ORDERID_LENGTH);
    }

    public static String getTempOpenId() {
        return getRandomOpenId(OPENID_LENGTH);
    }
    ...
    public static Map<String, String> getKeywordMap() {
        ...
        map.put("待退款", "'WAIT_REFUND|REFUNDING'");
        //派送中
