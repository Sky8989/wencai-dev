...
public class EnumUtils {
    ...
    public static PackageType packageTypeValueOf(String str) {
        ...
        switch (str) {
            case "0":
                type = PackageType.SMALl_PACKAGE;
                break;
            case "1":
                type = PackageType.CENTRN_PACKAGE;
                break;
            case "2":
                type = PackageType.BIG_PACKAGE;
                break;
            case "3":
                type = PackageType.HUGE_PACKAGE;
                break;
            default:
    ...
    public static DistributionMethod distributionValueOf(String str) {
        ...
        switch (str) {
            case "JISUDA":
                distribution = DistributionMethod.JISUDA;
                break;
            case "KUAISUDA":
                distribution = DistributionMethod.KUAISUDA;
                break;
            default:
                break;
        }
